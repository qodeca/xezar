...
- ✨ **A Claude Code leader can be woken by a project event, over Claude Code Channels.** (#374, part
  ...
  `POST /api/v1/mcp/leader {"action":"attach","client":"claude-code"}`. Channels are a Claude Code
