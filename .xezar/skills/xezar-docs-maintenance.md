---
name: xezar-docs-maintenance
description: Maintain owned documentation
---

# Maintain owned documentation

Find canonical docs and generated ownership. Root README is copied to the package at build; never edit that generated copy. Historical numbered specs are labels, not live paths. Maintain current links under docs/features. Make intended docs changes and focused validation in development; full gates and PR belong to their subsequent stages.

Inputs: actual maintained source and requested audience. Output: accurate examples, working links and owned documentation; inspect generated-file ownership instead of assuming docs/api exists. Report unverified examples and preserve historical observations as dated evidence.
