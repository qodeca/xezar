---
name: xezar-dependency-maintenance
description: Maintain npm dependencies
---

# Maintain npm dependencies

Use package-lock.json and the four real npm workspaces. Attribute updates to the importer workspace, including build-script dependencies. Use npm ci for reproducible setup. Fingerprint lock/shrinkwrap, root/workspace manifests, npm configuration, patches and Node/npm versions. No pnpm workspaces, foreign SDK generation, license tool or phantom lint command.

Inputs: bounded dependency need and importing workspace. Output: justified manifest/lock changes, compatibility/licensing considerations and affected checks. Avoid broad upgrades; use existing lockfile tooling and report unresolved installation failures.
