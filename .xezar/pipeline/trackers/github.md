...
This file is the GitHub implementation of the tracker operations contract. Every skill in the collection performs issue/PR state management through **named tracker operations** — `**get-issue**`, `**comment-pr**`, and so on — and this file defines what each operation means for GitHub, using the `gh` CLI.
...
gh label create refactor          --color d4c5f9 --description "Refactor"
gh label create testing           --color 0e8a16 --description "Test coverage and test infrastructure"
gh label create documentation     --color 0075ca --description "Improvements or additions to documentation"
gh label create needs-qa          --color fbca04 --description "Needs manual QA before merge"
