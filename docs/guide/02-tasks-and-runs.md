...
![New-task composer](../screenshots/0.18.0/new-task-dark-1280.png)
...
![Project task list with run statuses](../screenshots/0.18.0/tasks-list-dark-1280.png)
...
![Task thread with agent messages and tool activity](../screenshots/0.18.0/task-thread-dark-1280.png)
...
![Side-by-side variant comparison](../screenshots/0.18.0/compare-variants-dark-1280.png)
...
![Task Changes tab](../screenshots/0.18.0/task-changes-dark-1280.png)
...
![Review gate with feedback and Draft PR controls](../screenshots/0.18.0/review-gate-dark-1280.png)
