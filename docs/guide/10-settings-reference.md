...
- **Limits unknown** (`unknown`) means xezar could not read whether the login can work. It never means the login has budget. API-key logins report this state because they do not report plan limits.
