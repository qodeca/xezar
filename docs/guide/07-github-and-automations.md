...
![GitHub issues and the hand-to-agent panel](../screenshots/0.18.0/github-issues-dark-1280.png)
...
![An automation card with Test filter, Pause, Edit and View log controls](../screenshots/0.18.0/automations-dark-1280.png)
