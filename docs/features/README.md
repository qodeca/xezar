...
| --- | --- |
| [mcp-server/](mcp-server/mcp-project-leader-requirements.md) | The MCP server for a project leader: requirements (D-01 to D-09 in § 10: D-01, D-02, D-04, D-05, D-06 and D-09 have records; D-03 is detailed in the [settings classification](mcp-server/mcp-settings-classification.md); D-07/D-08 are settled in § 10), client evidence, the [whole-feature DoD](mcp-server/mcp-definition-of-done-record.md), [leader dogfooding findings](mcp-server/leader-dogfooding-2026-09-13.md), [pi extension](mcp-server/pi-leader-extension.md), wake decisions, and the generated [API reference](mcp-server/mcp-api.md). |
