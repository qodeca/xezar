...
| --- | --- |
| [mcp-server/](mcp-server/mcp-project-leader-requirements.md) | The MCP server for a project leader: requirements, decisions D-01 to D-09, client evidence, and the generated [API reference](mcp-server/mcp-api.md). |
