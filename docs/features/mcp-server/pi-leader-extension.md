...
Attach leader**, or `POST /api/v1/mcp/leader {"action":"attach","client":"pi"}` (no MCP action
attaches a leader yet). There is nothing to configure: you paste no address and set no environment
