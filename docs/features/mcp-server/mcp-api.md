...
| I-143 | Start the same scoped skill task with a brief for the bound project: `task_create` action `start`, `source: {source:'skill', ref:<the proje… | `task_create:start` |
...
| `task_create:start` | I-001, I-003, I-007, I-008, I-009, I-080, I-094, I-143 |  |  |  |
