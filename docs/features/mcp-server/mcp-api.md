...
| I-152 | Decided 2026-09-21 (owner: "Allow both, people and MCP (leader) to use the import my accounts functionality"). | `project_config:get_account`, `project_config:import_global_accounts` |
...
| `project_config:get_account` | I-042, I-122, I-152 |  |  |  |
