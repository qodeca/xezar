...
| I-007 | Choose runner/account/model on task creation, and observe `modelsLocked` | `discover_project`, `task_create:start`, `project_config:get_config`, `project_config:list_models`, `project_config:read_quota` |
