...
| `docs/specs/` (declared in `.xezar/pipeline/config.json`, currently absent — the numbered spec files were removed), `docs/testing/agent-browser.md` | Maintained specifications and browser contract. A new specification written there is maintained source, not an ignored working draft. |
