...
| Settings, project and global scopes | cockpit unit + browser e2e | `routes/settings/settings.test.tsx:164,271`; the Project setup / Worktrees / Branches sections, in `e2e/guide-01-getting-started.e2e.ts` and `e2e/guide-03-worktrees-and-git.e2e.ts` | C |
