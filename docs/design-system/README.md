...
The Claude Code skill in `.claude/skills/design-system/SKILL.md` points an agent here; `AGENTS.md` routes design work to this file; `.xezar/skills/xezar-ux-design.md` reads it before a design.
