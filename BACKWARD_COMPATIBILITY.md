...
- Agent quota (additive): `GET /api/v1/workspace/agent-quota` — the workspace-level, single-mount stored quota read described in the #867 S2 entry below. It is readable in local and hosted mode and starts no agent process.
