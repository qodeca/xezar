...
| [single-project-mode](single-project-mode/README.md) | Draft – the cockpit surface of single-project mode (the mode badge, Settings naming its file, the unavailable account, the three removals and the refused registry page) for PR4 of qodeca/xezar#600; six open decisions in `single-project-mode/README.md` §15 and the owner's unconfirmed answers in §16; waiting for the first `design-review` |
