...
| [design-system-air](design-system-air/README.md) | Draft, revision 4 – a design-system enhancement: rhythm tokens, looser between-block defaults, no hand-set pixels, a Roomy density; the step-0 full-page mockup set (eight surfaces at 1280 and 375 px, six states, four densities, both themes, violet accent, wide width); D-1..D-10 closed and two open points (6 – task-table wrapper, 7 – New-task button) waiting for the step-0 `design-review` verdict; filed as qodeca/xezar#424 |
