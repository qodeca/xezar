...
| [design-system-air](design-system-air/README.md) | Implemented (PRs #429, #432, #431, #437, #438, #441, then #574 and #585 for the Git, GitHub, Compare and Automations gutters, and #774 for the Settings loading gutters) – rhythm tokens, looser between-block defaults and Roomy density; #424 reopened 2026-09-17 for those pages and closed by #774; allowlist target met at two WCAG floor rows (#445, closed 2026-09-18); phone drawer target: #430 |
