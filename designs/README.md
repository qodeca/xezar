...
| [onboarding](onboarding/README.md) | Approved – the first-setup entry, the post-update Re-check / Later offer and the setup status surface (P2 of qodeca/xezar#464). Design review PASS WITH FOLLOW-UPS on #489 (`design-approved`); NB-1…NB-7 each carry a disposition in `onboarding/README.md` § 20, and the implementation lands in the P2 PR |
