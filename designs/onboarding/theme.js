...
// Same shape as designs/quality-checks/theme.js, with its own storage key.
(function () {
  ...
  try {
    if (localStorage.getItem('onb-mock-theme') === 'light') root.classList.add('light')
  } catch (e) {}
  document.addEventListener('click', function (event) {
    ...
    try {
      localStorage.setItem('onb-mock-theme', light ? 'light' : 'dark')
    } catch (e) {}
