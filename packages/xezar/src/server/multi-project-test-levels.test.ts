/**
 * Doc-check for `docs/testing/multi-project-test-levels.md` (#548 AC-1).
 *
 ...
 * `BREAK-MP-MATRIX-ROW-DROPPED` deletes one row's cited suite and expects the
 ...
 * the single source of truth and the two cannot drift. The levels are the same
 * five the sibling server-mode table uses, so a level outside that scale is a
 * red too.
 */
...
const TABLE_DOC = 'docs/testing/multi-project-test-levels.md';
...
describe('docs/testing/multi-project-test-levels.md', () => {
