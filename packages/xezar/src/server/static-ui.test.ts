...
describe('resolveGetRequest', () => {
  const cases: Array<{
    ...
    { name: '/xezar.svg (favicon) → passthrough', path: '/xezar.svg', target: 'passthrough' },
...
describe('BUILD_HINT_HTML', () => {
  it('is a self-contained page that tells a user how to repair the installed product', () => {
...
describe('assetContentType', () => {
  const cases: Array<[string, string]> = [
    ...
    ['xezar-toBr6SOa.svg', 'image/svg+xml'],
