 ...
 *
 * `cli.instance` (#467 PR 5, I-148) is IN the answer rather than out of it, and for the reason
 * the narrowing exists: it is a fact about the leader's OWN cockpit — which projects this process
 * serves — not a host path and not another project's data, and a leader that may change it must
 * be able to see what it changed it to.
 */
