...
/**
 * UI ↔ MCP parity for the GitHub tab's **New issue** control (#468, PR 5; inventory I-143).
 *
 ...
 */
describe('task_create as the New issue control’s MCP counterpart (#468, I-143)', () => {
