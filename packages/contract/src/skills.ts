...
/**
 * One discovered skill: repo (`.ai/skills`, `.xezar/skills`), `npx skills` install dirs
...
/** One entry of `.local/xezar/todos.json`, as `GET /todos` serves it (ids are backfilled on read). */
