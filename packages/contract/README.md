...
- **`@open-mercato/cezar-api-client`** depends on this package and re-exports it wholesale
  (`export * from '@open-mercato/cezar-contract'` in `packages/api-client/src/index.ts`), so a
