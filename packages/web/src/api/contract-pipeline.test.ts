...
import { healthResponseSchema, type HealthResponse } from '@qodeca/xezar-api-client'

/**
 * The `sync-contract` pipeline, end to end.
 *
 * `packages/xezar/src/contract/` is copied into the api-client at prebuild and compiled into its
